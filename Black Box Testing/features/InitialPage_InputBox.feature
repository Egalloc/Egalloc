...
@tag
Feature: Functionality and display of input box on initial page.
  Input box should have a dark gray outline and be centered in the middle of the page. Background color of the input box
  should be white. Background Color of initial page should be light gray.
...
Background:
  ...
  Scenario: Correct background color of initial page should be light gray
    Then Background Color of page is light gray

  Scenario: Correct color of input box outline
    Then Outline of input box is dark gray
   
  Scenario: Correct alignment of input box
    Then Input box is centered in the middle of the page
  ...
  Scenario: Correct background color of input box
    ...
    Scenario: Prompt text disappears when user begins typing a topic
        When User enters text "dogs" in input box
